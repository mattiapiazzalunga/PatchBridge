...
missing=0
check_tool "Git" "git" "$MIN_GIT" "sudo apt install git / sudo dnf install git / sudo pacman -S git" || missing=1
check_tool "Node.js" "node" "$MIN_NODE" "install Node.js 22.12+ from your package manager or https://nodejs.org/en/download" || missing=1
check_tool "npm" "npm" "$MIN_NPM" "install Node.js/npm from your package manager or https://nodejs.org/en/download" || missing=1
